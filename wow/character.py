class Character:
    def __init__(self, name: str, realm: str, level: int, faction: str, race: str, active_spec: str, character_class: str, average_item_level: int, guild: str, covenant_progress: str, achievement_points: int, **others: dict):
        self.name = name
